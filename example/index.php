...
$fancyExamplePlugin = new FancyExamplePlugin($hub);
$betterFormatter    = new BetterFormatter($hub);
$fancify            = new Fancify($hub);
$fancyExamplePlugin->subscribe();
$betterFormatter->subscribe();
$fancify->subscribe();
